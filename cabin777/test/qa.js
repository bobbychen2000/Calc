...
const VIEWS = {
  ...
  q09_centrePair: [`__rel('18D',1.2,1.72,-0.15,-Math.PI/2,-0.5)`, ['c_27314', 'c_27313'], 'centre pair 17E/18D seen across the aisle'],
  q10_seat14D: [`__rel('14D',0.95,1.72,-0.6,-Math.PI*0.8,-0.6)`, ['c_27315'], '14D from above the aisle'],
  ...
  q14_seat26A: [`__rel('26A',0.75,1.35,-0.9,Math.PI*0.72,-0.2)`, ['py_37301', 'py_37303'], 'PY window pair from the side'],
