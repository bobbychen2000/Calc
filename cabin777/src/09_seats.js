...
const SEATMAT = {
  ...
  ash: { c: '#c3bcad', r: 0.5, l: LAYER.ashGrain },
  ashDark: { c: '#5d6166', r: 0.34, m: 0.35, l: LAYER.brushed },
  rosewood: { c: '#4b403a', r: 0.36, l: LAYER.wood },
  jShell: { c: '#606369', r: 0.46, l: LAYER.plastic },
  jShellIn: { c: '#55585d', r: 0.5, l: LAYER.plastic },
  jRail: { c: '#74787e', r: 0.32, m: 0.3, l: LAYER.brushed },
...
function roomPart(part, opts = {}) {
  ...
  if (part === 'O') {
    ...
    capRail(B, 0.28, 0.16, 0.28, top + 0.30, -0.12);
    ...
    capRail(B, 0.34, 0.18, -0.33, top + 0.30, 0.66);
