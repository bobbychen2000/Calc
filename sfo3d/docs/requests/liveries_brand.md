...
- 24 Sep, later: `b744`, `b748`, `b763`, `bcs1`, `a333` re-converted (`tools/convert_models.py normalize_uvs`: garbage source
  ...
  `.sfom` files and their liveries together (the atlas layout changed).
