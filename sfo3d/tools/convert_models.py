...
The runtime (js/live/models.js) decodes it.
...
if __name__ == '__main__':
    ...
    with open(os.path.join(OUT, 'manifest.js'), 'w') as f:
        f.write('// generated by tools/convert_models.py\nexport const MODEL_DIMS = ' + json.dumps({k: v['dims'] for k, v in manifest.items()}, separators=(',', ':')) + ';\n')
