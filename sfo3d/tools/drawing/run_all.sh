...
cd tools/drawing
python3 -W ignore -c "from common import scene, provenance; scene(); p = provenance(); print('   scene: frame', p['frame'], 'git', p['git'], 'extracted', p['generated'][:16], 'stale inputs:', p['stale'])"
echo "== 2/5 deviations";  python3 -W ignore background.py; python3 -W ignore imreg.py; python3 -W ignore measure.py; python3 -W ignore selftest.py
